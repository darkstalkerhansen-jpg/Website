...
function checkifproxy() {
    if (window.location.hostname==="https://darkstalkerhansen-jpg.github.io") {
        document.getElementById("button2").style.backgroundColor="#FFFFFF";
        window.alert("launched normally");
    } else if (window.location.hostname==="https://darkstalkerhansen-jpg.github.io/Website/index.html") {
